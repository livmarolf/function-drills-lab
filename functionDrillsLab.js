...
/*
  ...
  possible with a certain amount of gold. Each chocolate frog costs 3 gold. Your function should take in a single parameter, 
  which is the amount of gold you are willing to spend. Your function should return a total amount of chocolate frogs you were able 
  to purchase.
  Create a variable called `totalFrogs` and set it equal to your function invoked, passing in the amount of gold you are willing to spend.
*/

//CODE HERE
function froggies(devBucks){
  let expensiveFrogs = 3
  return devBucks / expensiveFrogs
}
let totalFrogs = froggies(3000)
...
//CODE HERE
function froggies2(devBucks){
  let expensiveFrogs = 3
  let remainder=Math.floor(devBucks/expensiveFrogs)
  return remainder
}
let totalFrogs2 = froggies2(4)
...
let bathroomScope = ['skueaky', 'cute']
